import { IPortfolio, ISortObject, INumericValueSortKeys, IStockSortKeys } from '../types/portfolio.types';

export const sortItems = (object: IPortfolio, sortKey: IStockSortKeys, sortDirection: ISortObject['sortDirection']) => {
